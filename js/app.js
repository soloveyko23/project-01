(() => {
    ...
    const openSearch = () => {
        let toggleButton = document.querySelector(".search-button");
        let block = document.querySelector(".header-search-block");
        let menuIcon = document.querySelector(".icon-menu");
        if (document.documentElement.classList.contains("menu-open")) _slideUp(block, 500);
        toggleButton.addEventListener("click", (function() {
            if (!document.documentElement.classList.contains("overflow")) {
                document.documentElement.classList.add("overflow");
                toggleButton.classList.add("active");
                block.classList.add("active");
                _slideDown(block, 500);
            } else {
        ...
        document.addEventListener("click", (function(event) {
            ...
            if (targetElement !== toggleButton && targetElement !== menuIcon && !block.contains(targetElement)) {
                toggleButton.classList.remove("active");
                block.classList.remove("active");
                document.documentElement.classList.remove("overflow");
                _slideUp(block, 500);
        ...
        if (document.querySelector(".swiper")) {
            new core(".main-slider__slider", {
                ...
                pagination: {
                    ...
                    type: "fraction",
                    formatFraction: function(current, total) {
            ...
            new core(".news__slider", {
                ...
                grabCursor: true,
                navigation: {
                    prevEl: ".news .swiper-button-prev-2",
                    nextEl: ".news .swiper-button-next-2"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.2,
            ...
            new core(".media-materials__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                speed: 1e3,
                grabCursor: true,
                navigation: {
                    prevEl: ".media-materials .swiper-button-prev-2",
                    nextEl: ".media-materials .swiper-button-next-2"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.2,
                ...
                on: {
                    ...
                    slideChange: function() {
                        ...
                        slides[this.activeIndex].classList.add("last-slide");
                    }
                }
            });
            var featuresSlider = new core(".features-slider__slider ", {
                modules: [ Navigation, Pagination, Parallax ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                speed: 1e3,
                parallax: window.innerWidth >= 768,
                loop: true,
                allowTouchMove: false,
                on: {}
            });
        }
        let navigationButtons = document.querySelectorAll(".button-features");
        navigationButtons.forEach((function(button) {
            button.addEventListener("click", (function(e) {
                e.preventDefault();
                var slideIndex = parseInt(this.getAttribute("data-slide"));
                featuresSlider.slideTo(slideIndex);
                navigationButtons.forEach((function(button) {
    ...
    const menuWithDivider = () => {
        document.addEventListener("DOMContentLoaded", (function() {
            const menuItems = document.querySelectorAll(".navigation__menu-item a");
            const line = document.querySelector(".product-info .line");
            let activeItem = document.querySelector(".navigation__menu-item a.active, .navigation__menu-item a._navigator-active");
            let isScrolling = false;
            function updateDivider() {
                const itemRect = activeItem.getBoundingClientRect();
                const dividerRect = document.querySelector(".divider").getBoundingClientRect();
                const offsetX = itemRect.left - dividerRect.left;
            ...
            function handleScroll() {
                ...
                menuItems.forEach((item => {
                    const sectionId = item.getAttribute("data-goto");
                    const targetSection = document.querySelector(`${sectionId}`);
                    if (targetSection) {
                        const sectionTop = targetSection.offsetTop - 50;
                        const sectionHeight = targetSection.offsetHeight;
                        if (scrollPosition >= sectionTop && scrollPosition < sectionTop + sectionHeight) if (!item.classList.contains("active")) {
                            activeItem.classList.remove("active");
                            activeItem = item;
                            activeItem.classList.add("active");
                            updateDivider();
    ...
    const stickyBlock = () => {
        ...
        stickySections.forEach((function(section) {
            ...
            const stickyBlock = section.querySelector("[data-sticky-block]");
            if (bounding.bottom - 0 <= window.innerHeight && stickyBlock) {
                stickyBlock.style.transition = "transform 0.3s ease";
                stickyBlock.style.transform = "translateY(-100%)";
            } else if (bounding.top <= 0 && stickyBlock) {
                stickyBlock.style.position = "fixed";
                stickyBlock.style.top = "0";
                stickyBlock.style.left = bounding.left + "px";
                stickyBlock.style.width = bounding.width + "px";
                stickyBlock.style.transform = "translateY(0)";
                stickyBlock.classList.add("fixed");
            } else if (stickyBlock) {
                stickyBlock.style.position = "static";
                stickyBlock.style.width = "auto";
                stickyBlock.style.transform = "none";
                stickyBlock.classList.remove("fixed");
            }
        }));
    };
    const menuOpenLinks = () => {
        const menuLinks = document.querySelectorAll(".sidebar-menu__menu .menu__list > li > a");
        ...
        menuLinks.forEach((link => {
            link.addEventListener("click", (function(e) {
                ...
                const isActive = parentListItem.classList.contains("active");
                closeAllSubMenus();
                if (!isActive) {
                    parentListItem.querySelector(".sub-menu");
        ...
        let linkBack = document.querySelectorAll(".link-back");
        linkBack.forEach((element => {
            element.addEventListener("click", (function(e) {
                const target = e.target;
                e.preventDefault();
                console.log("34234234");
                const activeItem = target.closest(".sidebar-menu__menu .menu__list > li.active");
        ...
        function closeAllSubMenus() {
            document.querySelectorAll(".sidebar-menu__menu .menu__list > li > .sub-menu");
            const activeItems = document.querySelectorAll(".sidebar-menu__menu .menu__list > li.active");
    ...
    window.addEventListener("load", (function() {
        setTimeout((() => {
            const text = document.querySelector(".title-anim-h1");
            if (text) {
                ...
                function createSparkles() {
                    ...
                    text.appendChild(sparklesContainer);
                    for (let i = 0; i < 10; i++) {
            ...
            if (window.matchMedia("(min-width: 1024px)").matches) {
                let sections = gsap.utils.toArray(".alliance-appreciates__slide");
                gsap.to(sections, {
                    xPercent: -70 * (sections.length - 1),
                    ease: "ease",
                    scrollTrigger: {
                        trigger: ".alliance-appreciates",
                        start: "top 10%",
                        end: "bottom 40%",
                        pin: true,
                        scrub: 1,
            ...
            gsap.from(".main-slider__features", {
                opacity: 0,
                y: "50px",
                duration: 1,
                delay: .8,
            ...
            gsap.from(".main-slider__more-btn", {
                opacity: 0,
                y: "50px",
                duration: 1,
                delay: .8,
            ...
            gsap.from(".main-slider__image img", {
                scale: 1.35,
                duration: 3,
                delay: .3,
                ease: "power2.out"
            });
            gsap.to(".main-slider__icon", {
                opacity: .5,
                duration: 1,
                delay: .6,
                ease: "power2.out"
            });
            gsap.from(".hero-section .breadcrumb", {
                opacity: 0,
                y: "-50px",
                duration: 1,
                delay: .6,
            ...
            gsap.from(".hero-section__image", {
                scale: 1.35,
                duration: 3,
                delay: .3,
                ease: "power2.out"
            });
            gsap.to(".hero-section__icon", {
                opacity: .2,
                duration: 1,
                delay: .6,
                ease: "power2.out"
            });
            gsap.from(".hero-about__title", {
                opacity: 0,
                x: "-50px",
                duration: 1,
                delay: .5,
            ...
            gsap.from(".features-slide__title:first-child ", {
                opacity: 0,
                x: "-50px",
                duration: 1,
                delay: .5,
                ease: "power2.out",
                scrollTrigger: {
                    trigger: ".features-slider__slider"
                }
            });
            gsap.from(".features-slider__pagination ", {
                opacity: 0,
                y: "-50px",
                duration: 1,
                delay: .5,
            ...
            gsap.from(".features-slide__text:first-child ", {
                opacity: 0,
                y: "-50px",
                duration: 1,
                delay: .5,
            ...
            gsap.from(".features-slide__content:first-child ", {
                opacity: 0,
                x: -100,
                duration: 1,
                delay: .3,
            ...
            gsap.from(".features-slider__slide .features-slide__image img ", {
                scale: 1.2,
                duration: .5,
                delay: .7,
                ease: "power2.out",
            ...
            gsap.from(".news .swiper-navigation ", {
                opacity: 0,
                x: "50px",
                duration: 1,
                delay: .5,
            ...
            gsap.to(".projects__image-icon img", {
                opacity: .2,
                duration: 1,
                delay: .6,
                ease: "power2.out",
            ...
            gsap.from(".media-materials .media-item", {
                opacity: 0,
                y: "-50px",
                duration: 1,
                delay: .5,
                ease: "power2.out",
                scrollTrigger: {
                    trigger: ".media-materials"
                }
            });
            gsap.from(".activity-company__item", {
                opacity: 0,
                y: "-50px",
                duration: 1,
                delay: .5,
                ease: "power2.out",
                scrollTrigger: {
                    trigger: ".activity-company"
                }
            });
            gsap.from(".hero-about__more-btn", {
                opacity: 0,
                y: "50px",
                duration: 1,
                delay: .5,
            ...
            gsap.from(".news-item__image img", {
                opacity: 0,
                scale: 1.1,
                duration: 1,
                delay: .5,
            ...
            gsap.from(".product-info__navigation", {
                opacity: 0,
                y: "100px",
                duration: 1,
                delay: .5,
            ...
            gsap.from(".certificates-list-tabs", {
                opacity: 0,
                y: "100px",
                duration: 1,
                delay: 1.2,
            ...
            gsap.from(".products__list", {
                ...
                ease: "power2.out",
                scrollTrigger: {
                    trigger: ".products-tabs__body"
                }
            });
            gsap.from(".report-alliance", {
                scale: .9,
                duration: 1,
                delay: .5,
                ease: "power2.out",
                scrollTrigger: {
                    trigger: ".report-alliance",
                    start: "start 80%",
                    end: "bottom 100%",
                    scrub: 1
                }
            ...
            gsap.from(".what-we-offer__image", {
                scale: 1.2,
                duration: 1,
                delay: .5,
                ease: "power2.out"
            ...
            const observer = new IntersectionObserver(((entries, observer) => {
                entries.forEach((entry => {
                    if (entry.isIntersecting) {
                        ...
                        const wrapper = element.closest("[data-watch]");
                        if (wrapper && wrapper.classList.contains("_watcher-view")) {
                            let animation;
                            switch (animationType) {
                              ...
                              case "slide-left":
                                animation = gsap.from(element, {
                                    opacity: 0,
                                    x: (element.dataset.index + 1) * -50,
                                    duration: .7,
                                    delay: element.dataset.index * .35
                                });
                                break;
                              ...
                              case "table-scale":
                                animation = gsap.fromTo(element, {
                                    ...
                                    duration: .3,
                                    ease: "power2.inOut",
                                    delay: .3 + element.dataset.index * .1,
                                    onComplete: () => {
                                        gsap.to(element, {
            ...
            blocks.forEach((block => {
                ...
                const items = Array.from(parentNode.children);
                items.forEach(((item, index) => {
                    item.dataset.index = index;
                    item.dataset.animationType = "slide-left";
                    observer.observe(item);
                }));
            }));
            const tableTr = document.querySelectorAll("table > tbody > tr");
            tableTr.forEach((block => {
                const parentNode = block.parentNode;
                const items = Array.from(parentNode.children);
                items.forEach(((item, index) => {
                    item.dataset.index = index;
                    item.dataset.animationType = "table-scale";
                    observer.observe(item);
                }));
            }));
            const titleElements = document.querySelectorAll(".title-h2, .slide-card__title, .report-alliance__title, .form");
            titleElements.forEach(((element, index) => {
                element.dataset.animationType = "fade";
                element.dataset.index = index;
                observer.observe(element);
            }));
            const textElements = document.querySelectorAll(".text-01, .text-02, .text-03");
            textElements.forEach(((element, index) => {
                element.dataset.animationType = "slide";
                element.dataset.index = index;
                observer.observe(element);
            }));
        }), 500);
